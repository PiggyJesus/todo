...
const TaskSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'importance': PropertySchema(
      ...
      name: r'importance',
      type: IsarType.byte,
      enumMap: _TaskimportanceEnumValueMap,
    ),
...
void _taskSerialize(
  ...
  writer.writeDateTime(offsets[0], object.doUntil);
...
Task _taskDeserialize(
  ...
  final object = Task();
  object.doUntil = reader.readDateTimeOrNull(offsets[0]);
  object.importance =
      _TaskimportanceValueEnumMap[reader.readByteOrNull(offsets[1])] ??
          Importance.low;
...
P _taskDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (_TaskimportanceValueEnumMap[reader.readByteOrNull(offset)] ??
          Importance.low) as P;
    case 2:
...
const _TaskimportanceEnumValueMap = {
  'low': 0,
  'common': 1,
  'high': 2,
};
const _TaskimportanceValueEnumMap = {
  0: Importance.low,
  1: Importance.common,
  2: Importance.high,
};
...
extension TaskQueryFilter on QueryBuilder<Task, Task, QFilterCondition> {
  QueryBuilder<Task, Task, QAfterFilterCondition> doUntilIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> doUntilIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> doUntilEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> doUntilGreaterThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> doUntilLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> doUntilBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> importanceEqualTo(
      Importance value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
...
extension TaskQuerySortBy on QueryBuilder<Task, Task, QSortBy> {
  QueryBuilder<Task, Task, QAfterSortBy> sortByDoUntil() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'doUntil', Sort.asc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> sortByDoUntilDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'doUntil', Sort.desc);
    });
  }
...
extension TaskQuerySortThenBy on QueryBuilder<Task, Task, QSortThenBy> {
  QueryBuilder<Task, Task, QAfterSortBy> thenByDoUntil() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'doUntil', Sort.asc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> thenByDoUntilDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'doUntil', Sort.desc);
    });
  }
...
extension TaskQueryWhereDistinct on QueryBuilder<Task, Task, QDistinct> {
  QueryBuilder<Task, Task, QDistinct> distinctByDoUntil() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'doUntil');
    });
  }
...
extension TaskQueryProperty on QueryBuilder<Task, Task, QQueryProperty> {
  ...
  QueryBuilder<Task, DateTime?, QQueryOperations> doUntilProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'doUntil');
    });
  }

  QueryBuilder<Task, Importance, QQueryOperations> importanceProperty() {
    return QueryBuilder.apply(this, (query) {
